...
var host = 'http://10.199.14.46:8002/api/capaian-unit/'
var dropdownDataDasar = 'http://10.199.14.46:8002/api/data-dasar/nama/'
var dropdownSatuanKerja = 'http://10.199.14.46:8002/api/satuan-kerja/nama/'
export default {
  // name: 'App',
  data() {
    return {
